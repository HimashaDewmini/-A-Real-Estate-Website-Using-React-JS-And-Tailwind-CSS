    ...
    <div className='flex flex-col items-start gap-8 lg:flex-row'>
          ...
          <form className='flex flex-col gap-y-4'>
            ...
            <div className='flex gap-x-2'>
              ...
              <button className='border boder-violet-700 text-violet-700 hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition'>Call</button>
            </div>
